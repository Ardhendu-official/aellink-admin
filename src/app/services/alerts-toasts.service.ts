...
export class AlertsToastsService implements OnInit {
    ...
    // Wallet Money Add Success Alert Begin | Called from checkout.page.ts
    async walletmoneyaddsucces(response) {
    ...
    // Wallet Money Add Success Alert End

    // Wallet Money Add Success Alert Begin | Called from checkout.page.ts
    async walletmoneyaddfailed(response) {
        const tc = await this.toastCtrl.create({
            message: response,
            duration: 2000,
            cssClass: 'toast',
    ...
    // Phone Number update Success Alert Begin | Called from checkout.page.ts
    async updatephonenumber(response) {
        const tc = await this.toastCtrl.create({
            message: response,
            duration: 2000,
            cssClass: 'toast',
    ...
    // Phone Number update Success Alert End
    ...
    async signupSuccessToast(response, type) {
        const tc = await this.toastCtrl.create({
            message: response,
            duration: 2000,
            cssClass: 'toast',
